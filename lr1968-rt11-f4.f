...
C     Dec 2022
C
C     Tweaked to run on RT-11 FORTRAN IV for the Digital PDP-11
C     Michael Robinson, kb1dds@gmail.com
C     2022-DEC-06
C
      PROGRAM COMTE
...
59    FORMAT (2X,'OHIO   NS=312.'//)
      ...
      H1G=4.
      H1E=4.
      IF (IX .NE. 3 .AND. I .EQ. 9) H1G=3.3
      IF (IX .NE. 3 .AND. I .EQ. 9) H1E=3.3
      IF (IX .EQ. 3 .AND. I .GT. 6) H1G=4.24
      IF (IX .EQ. 3 .AND. I .GT. 6) H1E=4.24
      IF (IX .EQ. 3 .AND. I .EQ. 9) H1G=3.68
      IF (IX .EQ. 3 .AND. I .EQ. 9) H1E=3.68
      H2G=3.
      H2E=3.
      IF (I .EQ. 2 .OR. I .EQ. 5) H2G=6.
      IF (I .EQ. 2 .OR. I .EQ. 5) H2E=6.
      IF (I .EQ. 3 .OR. I .EQ. 6) H2G=9.
      IF (I .EQ. 3 .OR. I .EQ. 6) H2E=9.
      IF (IX .EQ. 3 .AND. I .EQ. 7) H2G=1.
      IF (IX .EQ. 3 .AND. I .EQ. 7) H2E=1.
      IF (IX .NE. 3 .AND. I .EQ. 7) H2G=.55
      IF (IX .NE. 3 .AND. I .EQ. 7) H2E=.55
      IF (IX .NE. 3 .AND. I .EQ. 8) H2G=1.7
      IF (IX .NE. 3 .AND. I .EQ. 8) H2E=1.7
      IF (IX .NE. 3 .AND. I .EQ. 9) H2G=1.3
      IF (IX .NE. 3 .AND. I .EQ. 9) H2E=1.3
      DLS1=SQRT(.002*A*H1E)
      DLS2=SQRT(.002*A*H2E)
      DLS=DLS1+DLS2
